              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    value={formData.role}
                    onChange={handleInputChange}
                    className="w-full bg-white border border-gray-300 px-4 py-3 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                  >
                ...
                <div className="flex items-start">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="mt-1 mr-3 w-4 h-4 text-orange-500 bg-white border-gray-300 rounded focus:ring-orange-500"
                  />
