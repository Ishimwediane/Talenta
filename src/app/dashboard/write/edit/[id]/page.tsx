...
import { ArrowLeft, Save, BookOpen, Edit3, FileUp, AlertCircle } from "lucide-react";
...
export default function EditBook() {
  ...
  const handleSubmit = async (status: 'DRAFT' | 'PUBLISHED') => {
    ...
    try {
      await apiService.updateBook(bookId, formData);
                    ...
                    {existingBookFileName && (
                      <div className="p-3 bg-blue-50 border border-blue-200 rounded-md">
                        <p className="text-blue-800 text-sm">
                          <strong>Current file:</strong> {existingBookFileName}
                        </p>
                      </div>
                    )}
                    <Input 
                ...
                <CardContent className="p-6">
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
                    ...
                    <p className="text-lg font-medium text-gray-900 mb-2">
                      {bookFile ? bookFile.name : "Upload new book file"}
                    </p>
                    ...
                    {bookFile && (
                      <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-md">
                        <p className="text-green-800 text-sm">
                          ✓ New file selected: {bookFile.name}
                        </p>
