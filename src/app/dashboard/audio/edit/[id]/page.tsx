...
import { Play, Pause, Volume2, Mic, Square, Trash2, Save, Upload, AlertCircle, CheckCircle, Plus, X, ArrowUp, ArrowDown, Edit3, ArrowLeft } from "lucide-react";
...
export default function EditAudioPage() {
  ...
  }, [isAuthenticated, router, audioId]);
  ...
  const fetchAudio = async () => {
    try {
      ...
      if (data.audio.user?.id !== user?.id) {
        throw new Error('You can only edit your own audio content');
      }
